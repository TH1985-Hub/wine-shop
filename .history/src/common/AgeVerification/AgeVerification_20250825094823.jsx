...
function AgeVerification() {
  ...
  return (
    <div className={styles.ageVerificationContainer}>
      <div className={styles.ageVerification__content}>
        <div className={styles.ageVerification__imageWrapper}>
          <img
            src={splashWine}
            alt="Red wine splash"
            className={styles.ageVerification__image}
          />
        </div>
