...
// src/pages/AgeVerification/AgeVerification.jsx
import { useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { Flex, Typography, Button } from 'antd';
import styles from './AgeVerification.module.scss';
import splashWine from '<div className="" />
<asset></asset>/red-wine-splash.png'; // your image
  ...
  return (
    <Flex justify='center' align='center' className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <Flex justify='center' gap={30} className={styles.buttons}>
          <Button onClick={handleYesClick}>Yes, I'm over 18</Button>
          <Button danger onClick={handleNoClick}>No, not yet</Button>
        </Flex>
      </div>
    </Flex>
  );
