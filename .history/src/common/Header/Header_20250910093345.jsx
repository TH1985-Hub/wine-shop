...
function Header({ lang = "en", setLang = () => {}, setOpened }) {
  ...
  const navItemsLeft = [
    { to: "/", key: "home", label: texts[] "Home" },
    { to: "/about-us", key: "about", label: "About Us" },
    { to: "/tours", key: "tours", label: "Tours" },
    { to: "/wines", key: "wines", label: "Wines" },
  ];

  const navItemsRight = [
    { to: "/social", key: "social", label: "Social" },
    { to: "/terroir", key: "terroir", label: "Terroir" },
