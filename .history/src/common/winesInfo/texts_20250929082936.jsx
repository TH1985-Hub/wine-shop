...
import redDry from './images/Bambak/red.dry.png';
...
export const wines =[  
{
  ...
  text: {
    : "Ծաղկային, մրգային նուրբ բույր տանձի, կանաչ խնձորի և նարնջի նոտաներով, հարմոնիկ, մրգային նուրբ համ հավասարակշռված թթվայնությամբ:",
...
},
{
  ...
  "text": {
    "hy": "Հագեցված, հատապտուղների և ծաղկային տոներ՝ արտահայտված բույրերով սև հաղարջի, բալի, վարդերի և համեմունքների, հարստացված հագեցված, մրգային, հավասարակշռված և թավշյա տանինային համով: Նուրբ, երկար հետհամ:",
...
},
{
  ...
  "text": {
    "hy": "Հագեցված, հատապտուղների և ծաղկային տոներ՝ արտահայտված բույրերով համեմունքների, բալի, նռանի և կաղնու, հարմոնիկ համ հատապտուղների, կաղնու և թավշյա տանիններով",
...
},
{
  ...
  "text": {
    "hy": "Հագեցված, արևադարձային մրգերի, կծվածիկի և ելակի տոներով, հարմոնիկ համ գրեյպֆրուտի, կծվածիկի և ելակի նոտաներով: Երկար հետհամ քաղցր և հարմոնիկ նոտաներով",
...
},
{
  "id": 5,
  "title": {
    "hy": "Հատուկ Ընտրանի Տիգրանի Կարմիր Չոր",
    "ru": "Специальная Сеlection Тиграни Красное Сухое",
    "en": "Special Selection Tigrani Red Dry"
  },
  "text": {
    "hy": "Հագեցված, հատապտուղների տոներ՝ արտահայտված բույրերով մոշի, սև հաղարջի և կաղնու, հարմոնիկ համ հատապտուղների, կաղնու և թավշյա տանիններով",
...
},
{
  ...
  "text": {
    "hy": "Ծաղկային, մրգային նուրբ բույր տանձի, կանաչ խնձորի և նարնջի նոտաներով, հարմոնիկ, մրգային նուրբ համ հավասարակշռված թթվայնությամբ:",
    "ru": "Цветочный, фруктовый нежный аромат с грушей, зеленым яблоком и апельсином, гармоничный, фруктовый нежный вкус со сбалансированной кислотностью.",
    "en": "Floral, fruit delicate aroma with pear, green apple and orange, harmonious, fruit delicate taste with balanced acidity."
  }
},
