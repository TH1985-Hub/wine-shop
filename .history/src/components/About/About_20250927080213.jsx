...
import upperBg from "./images/bg-upper.png";
import bottomBg from "./images/bg-bottom.png";

// const About = () => {
//   const { currentLanguage } = useLanguage(); // assuming context returns object
//   const navigate = useNavigate();
//   const texts = aboutTexts[currentLanguage] || aboutTexts.en;
...
//       {/* Upper background */}
//       <div className={styles.upperBackground}>
//         <img src={upperBg} alt="Vineyard landscape" className={styles.upperImage} />
//       </div>
...
const About = () => {
  ...
  const handleDiscoverWines = (e) => {
    e.preventDefault();
    e.stopPropagation();
    console.log("Navigating to wines page");
    navigate("/wines");
  };
