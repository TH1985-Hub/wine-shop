...
//   const titles = categoryTitles || wineCategoryTitles;
  
//   const titleOne = titles?.jraghatspanyan?.[lang] || titles?.jraghatspanyan?.en || "Jraghatspanyan Collection";
//   const titleTwo = titles?.bambak?.[lang] || titles?.bambak?.en || "Bambak Collection";

//   const jrCards = useMemo(() => {
//     return (wines.length > 0 ? wines : [])
//       .filter((w) => w?.category === "jraghatspanyan")
//       .slice(0, 6)
//       .map((c, i) => ({
//         key: c?.id || `jr-${i}`,
...
// import { Row, Col, Typography, Flex } from "antd";
// import styles from "./Products.module.css";
// import { wines as importedWines } from '../../../common/winesInfo/texts'; // Rename import
// import { wineCategoryTitles } from '../../../common/winesInfo/titles';
// import WineCard from "../../../common/WineCard/WineCard";
// import { useLanguage } from "../../../contexts/LanguageContext";
...
// export default function Product({ wines = importedWines, categoryTitles }) { // Use importedWines as default
//   const { language, currentLanguage } = useLanguage();
//   const lang = language || currentLanguage || "en";
...
//     <div className={styles.container}>
//       <section className={styles.categorySection}>
//         <Flex vertical align="flex-start" gap={16}> {/* Changed to flex-start */}
//           <Title level={3} className={styles.categoryTitle}>
//             {titleOne}
//           </Title>
//           <Row gutter={[24, 24]} justify="start"> {/* Changed to start */}
//             {jrCards.map((item) => (
//               <Col key={item.key} xs={24} sm={12} md={12} lg={8} xl={6} className={styles.col}>
//                 <WineCard 
//                   image={item.image} 
...
//   const titleOne = categoryTitles.jraghatspanyan?.[lang] || categoryTitles.jraghatspanyan?.en;
//   const titleTwo = categoryTitles.bambak?.[lang] || categoryTitles.bambak?.en;
...
//   const jrCards = useMemo(() => filterCards("jraghatspanyan", 6), [wines, lang]);
//   const bambakCards = useMemo(() => filterCards("bambak", 4), [wines, lang]);
...
//     <div className={styles.container}>
//       <section className={styles.categorySection}>
//         <Title level={3} className={styles.categoryTitle}>{titleOne}</Title>
//         {renderCards(jrCards)}
//       </section>

//       <section className={styles.categorySection}>
//         <Title level={3} className={styles.categoryTitle}>{titleTwo}</Title>
//         {renderCards(bambakCards)}
//       </section>
//     </div>
//   );
// }
