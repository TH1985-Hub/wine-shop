        ...
        <div className={styles.textContent}>
          ...
          <div className={styles.description}>
            {texts.description.split("\n").map((paragraph, index) => (
                 const isCentered = paragraph.includes('<center>');
                 const cleanParagraph = paragraph.replace(/<center>|<\/center>/g, ''); const isCentered = paragraph.includes('<center>');
                 const cleanParagraph = paragraph.replace(/<center>|<\/center>/g, '');
              <p key={index} 
                 className=""
